            ...
            sections: [
              {
                "rows": [{
                  "title": ` 👨 OWNER CEKILXD`,
                  "description": "Nomor CekilXd Chat P/Meminta Save Tidak Akan Di Respon",
                  "rowId": `.owner`
                },{
                  "title": "❗ SEWA BOT",
...
//━━━━━━━━[ SETTINGS MENU ]━━━━━━━━//
    ...
    conn.reply(m.chat, 'Menu Sedang Error Kontol', m)
    throw e
  }
}
...
function ucapan() {
  ...
  if (time >= 4) {
    res = "Selamat Pagi Kontol"
  }
  if (time > 10) {
    res = "Selamat Siang Kontol"
  }
  if (time >= 15) {
    res = "Selamat Sore Kontol"
  }
  if (time >= 18) {
    res = "Selamat Malam Kontol"
  }
  return res
}
